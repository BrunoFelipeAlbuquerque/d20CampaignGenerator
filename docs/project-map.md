...
As of this map, the foundation domains, P4 feat selection composition adapters, P5 core ability composition adapters, and the first P6 class-level/BAB adapters are present. Check `BACKLOG.md` for exact unchecked work.
...
The P5 core character ability composition path is complete, and P6 now has character level facts plus base attack bonus facts. Continue by composing base saving throw facts and HP ledger entries at the `character` boundary.
